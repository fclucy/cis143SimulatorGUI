...
public class targetMenuGUI extends JFrame {
    ...
    public targetMenuGUI() {
        ...
        JLabel classificationBanner = new JLabel("SECRET", SwingConstants.CENTER);
        classificationBanner.setOpaque(true);
        classificationBanner.setBackground(new Color(200, 0, 0)); // Bright red
    ...
    private void showWarningDialog() {
		...
		int response = JOptionPane.showOptionDialog(null,
				"<html><body style='width: 300px;'><p>" + message + "</p></body></html>", "Simulation Warning & Terms",
